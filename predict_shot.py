...
def get_angle(img, landmark_list, point1, point2, point3, draw=True):   
        ...
        if draw and (point1 == 11 or point1 == 23 or point1 == 13) and (point2 == 13 or point2 == 25 or point2 == 23 or point2 == 11 ) and (point3 == 15 or point3 == 27 or point3 == 25 or point3 == 23):
